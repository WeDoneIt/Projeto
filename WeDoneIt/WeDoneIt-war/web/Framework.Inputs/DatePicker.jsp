...
<div class="input-group input-group-sm ajuste">
    <input onkeydown="dateMask(event)" maxlength="10" type="text" class="form-control" id="<c:out value='${param.name}'/>" name="<c:out value='${param.name}'/>" style="margin-left: 1%; width: 90%; margin-right: 1%;"/>
</div>
